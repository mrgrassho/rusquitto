...
pub use packet::{
    ...
    encode_connack_with_retain_available, encode_disconnect, encode_frame, encode_pingresp,
    encode_puback, encode_pubcomp, encode_publish, encode_pubrec, encode_pubrel, encode_suback,
    encode_unsuback, read_frame, Frame, MqttPacket, ProtocolError, ProtocolVersion, Publication,
